...
#define SLAVE1_MAGIC_REG (BOOTROM_BASE+0x38)
#define SLAVE2_MAGIC_REG (BOOTROM_BASE+0x38)
#define SLAVE3_MAGIC_REG (BOOTROM_BASE+0x38)
#define SLAVE4_MAGIC_REG (BOOTROM_BASE+0x3C)
#define SLAVE5_MAGIC_REG (BOOTROM_BASE+0x3C)
#define SLAVE6_MAGIC_REG (BOOTROM_BASE+0x3C)
#define SLAVE7_MAGIC_REG (BOOTROM_BASE+0x3C)
...
#define SLAVE_JUMP_REG  (BOOTROM_BASE+0x34)
